...
<div style="float:left;width:100%">
    <form action="{{ URL::action(\App\Utils\ConstantUtil::PROJECT_ADMIN.'\ArticleClassController@update')}}" method="post" id="form1"  >
        <div class="form-group width50">
            <label for="exampleInputEmail1">分类名称：</label>
            <input type="text" class="form-control" value="{{$Row['name']}}" placeholder="分类名称" name="name">
