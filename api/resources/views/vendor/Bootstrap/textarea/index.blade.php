...
<div class="container">
    <div class="hero-unit">
        <div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
            ...
            <div class="btn-group">
                <a class="btn" data-edit="iphone_check" title="手机端预览"><i class="glyphicon glyphicon-phone"></i></a>
            </div>
            <input type="text" data-edit="inserttext" id="voiceBtn" x-webkit-speech="">
        </div>

        <div id="editor">@if(!empty($textarea_value)){!! $textarea_value !!}@endif</div>
    ...
    <script>
        $(function(){
            $("a[data-edit='iphone_check']").click(function() {
                $("#mymodal_textarea_5").modal("toggle");
                var textarea_html = $("#editor").html();
                var screen_height = window.screen.height;
                screen_height = screen_height*0.7;
                $("#model-body-textarea_5").attr("style","height:"+screen_height+";overflow-y:scroll");
                $("#model-body-textarea_5").html(textarea_html);
            });
    ...
    <!-- Modal -->
    <div class="modal" id="mymodal_textarea_5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
        <div class="modal-dialog width500" role="document">
            <div class="modal-content" >
                ...
                <div class="modal-body" id="model-body-textarea_5"></div>
